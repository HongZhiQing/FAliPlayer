...
class AliPlayerSingleView extends StatefulWidget {
  final FAliSinglePlayerController controller;
  final String url;
  final bool isCurrentLocation;

  const AliPlayerSingleView(
      {Key key, this.controller, this.isCurrentLocation, this.url})
      : super(key: key);

  @override
  _AliPlayerSingleViewState createState() => _AliPlayerSingleViewState();
}

class _AliPlayerSingleViewState extends State<AliPlayerSingleView> {
  @override
  void initState() {
