...
class FAliListPlayerView extends StatefulWidget {
  ...
  @override
  _FAliListPlayerViewState createState() => _FAliListPlayerViewState();
}

class _FAliListPlayerViewState extends State<FAliListPlayerView> {
